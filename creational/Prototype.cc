...
class PrototypeFactory {
 ...
 public:
  PrototypeFactory() {
    prototypes_[Type::PROTOTYPE_1] = std::make_shared<ConcretePrototype1>(ConcretePrototype1("PROTOTYPE_1 ", 50.f));
    prototypes_[Type::PROTOTYPE_2] = std::make_shared<ConcretePrototype2>(ConcretePrototype2("PROTOTYPE_2 ", 60.f));
  }
...
void Client(std::shared_ptr<PrototypeFactory> prototype_factory) {
